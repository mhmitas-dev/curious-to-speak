    ...
    return (
        <main>
            <section className='border-b'>
                <nav className='flex items-center justify-between custom-container'>
                    <div>
            ...
            <section className="flex-1 flex items-center">
                <div className="max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-10 sm:py-14 lg:py-12 grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
                    ...
                    <div className="space-y-6 text-center lg:text-left">
                        ...
                        <p className="text-base font-semibold sm:text-nd text-muted-foreground max-w-md mx-auto lg:mx-0">
